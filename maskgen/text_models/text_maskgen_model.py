...
import math
from transformers import ViTModel, CLIPVisionModel, DistilBertModel
...
class MaskGeneratingModel(nn.Module):
    def __init__(self, pred_model: nn.Module, hidden_size, num_classes):
        ...
        self.vit = DistilBertModel.from_pretrained("distilbert-base-uncased-finetuned-sst-2-english")
    ...
    def train_one_batch(self, x: torch.Tensor, optimizer: torch.optim.Optimizer, n_steps=10, n_samples=1):
        device = x.device
        self.train()
